...
def train_and_pick():
    ...
    plt.plot(test_size, test_accuracy_list, )
    best_model, best_model_index = pick_model(test_accuracy_list, models)
    print(f"Model #{best_model_index} has the highest prediction with {test_accuracy_list[best_model_index] * 100:.2f}%")
    return best_model
...
save_model(best_model, "../saved_models/diabetes_model.sav")